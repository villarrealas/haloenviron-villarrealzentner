...
In Figure~\ref{fig:splashback_compare}, we show a first, broad comparison of our work with halo splashback radii. 

that a one-to-one comparison between the two methods is difficult
