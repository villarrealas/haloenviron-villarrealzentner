...
\centering
\includegraphics[width=.5\textwidth]{masscut_cnfw_d200.pdf}
\caption{\arz{I am putting this here as a placeholder. Notice that the figure is identical to Fig.~\ref{fig:cnfwrelation}. This is here as a placeholder. What should appear here is a figure that is the analog for Fig.~\ref{fig:cnfwrelation} but exploring the property $c_{\mathrm{V}}$. We must have the analogous figure for each of the halo properties that we explore.}}
...
as a function of halo mass for $\Delta=200$ is shown in Figure~\ref{fig:relation} along with the mass 
...
\centering
\includegraphics[width=.5\textwidth]{masscut_cnfw_d200.pdf}
\caption{\arz{I am putting this here as a placeholder. Notice that the figure is identical to Fig.~\ref{fig:cnfwrelation}. This is here as a placeholder. What should appear here is a figure that is the analog for Fig.~\ref{fig:cnfwrelation} but exploring the property $s$. We must have the analogous figure for each of the halo properties that we explore.}}
\label{fig:srelation}
\end{figure}
%--------------------------------------------------------------------------------


\arz{Make the analogous new paragraph for the spin parameter please. Isn't the conventional parameter for the spin parameter a lower case $\lambda$? It doesn't matter too much, but we shouldn't deviate from convention without a pretty good reason.}
\beq
\lambda = \frac{J \sqrt{\lvert E\rvert}}{G M_{vir}^{2.5}}
\eeq
...
\centering
\includegraphics[width=.5\textwidth]{masscut_cnfw_d200.pdf}
\caption{\arz{I am putting this here as a placeholder. Notice that the figure is identical to Fig.~\ref{fig:cnfwrelation}. This is here as a placeholder. What should appear here is a figure that is the analog for Fig.~\ref{fig:cnfwrelation} but exploring the property $\lambda$. We must have the analogous figure for each of the halo properties that we explore.}}
\label{fig:srelation}
\end{figure}
%--------------------------------------------------------------------------------
...
\arz{After this rewrite, the following paragraph can probably be removed with relevant info and references moved into the appropriate places above.}
