...
papers here, Gao, Wechsler, Harker, Zentner07, Dalal07, probably several more.} 

\arz{The language in this paragraph is way too loose and not sufficiently clear or professional. I'll attemp to clean it up. Try to 
follow this model in your writing.}
...
\arz{Given how the correlation function looks, shouldn't we include results for $\Delta<50$, at least for the L0125 results? The 
effect is continuous so it looks like it would be removed with a smaller value of $\Delta$. I say this is a must for moving forward 
with publication.}
