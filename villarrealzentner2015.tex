...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_cf_compare_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_cf_compare_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_cf_compare_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_cf_compare_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_cnfw_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_cnfw_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_cnfw_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_mcf_cnfw_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_vrat_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_vrat_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_vrat_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_mcf_vrat_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_s_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_s_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_s_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_mcf_s_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_spin_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_spin_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_spin_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_mcf_spin_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_ns_z00_hosts.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_ns_z00_hosts.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_ns_z00_hosts.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{ld_mcf_ns_z00_hosts.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_cf_compare_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_cf_compare_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_cnfw_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_cnfw_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_vrat_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_vrat_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_s_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_s_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_ns_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_ns_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_spin_z00_l0125cut.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_spin_z00_l0125cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_cf_compare_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_cf_compare_z00_l0500cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_cnfw_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_cnfw_z00_l0500cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_vrat_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_vrat_z00_l0500cut.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the velocity ratio utilizing the 'l0500cut' mass cutoffs. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_s_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_s_z00_l0500cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_ns_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_ns_z00_l0500cut.pdf}} }
...
\begin{figure*}
	\centering
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_spin_z00_l0500cut.pdf}} }
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_spin_z00_l0500cut.pdf}} }
...
%% clearpage is here to try to make this actually compile! I DON'T KNOW WHY.
\clearpage

In addition to this study of how the choice of mass cut effects our best choice of model, we would also like to explore the nature of how this method functions. For example, we would like to know if it is a more careful selection of halos in our simulation that results in the removal of this apparent assembly bias or if it is the increased noise in the statistics as a result of reducing the number of halos. There is also the possibility of halo statistics changing as a result of the new halo definitions to be considered. One can imagine that the addition of a large amount of mass toward the edge of the halo would reasonably change measures of concentration, shape, and spin. To test some of these possibilities, we run an algorithm to match halos across our multiple catalogs. We identify halos that are within a distance tolerance that we scale such that there are no identifications of multiple halos to the same object in another catalog. Catalogs are all matched against a single target catalog. This target catalog is chosen to fit the value of $\Delta$ that we find best removes assembly bias in large scales for the concentration marks chosen. For the Diemer et al. simulations, we find this to be a value of approximately $\Delta = 70$, while the Consuelo simulation favors a slightly higher value of $\Delta = 90$. Once the catalogs have been matched against this primary catalog, we rerun our marked correlation function calculations using only halos identified across both catalogs. This tests if the exclusion of halos that are subsumed in the lower $\Delta$ catalog is the primary cause of our results. We can see the results of this test in Figures 21 through 26. In each case, the $\Delta = 200$ result when utilizing a catalog matched to our best fit $\Delta$ demonstrates less assembly bias than the full catalog for the mass cut would demonstrate.
%% using  the L0500 as a placeholder for the LasDamas matches while those are being rerun for consistency
%% qualitative results are more or less the same.
\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_cf_compare_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_cf_compare_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_cf_compare_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_cf_compare_z00_hosts_match.pdf}} }
	\caption{The difference of the correlation function of all hosts compared to a cut of the 20 \% highest or lowest NFW defined concentration halos utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The solid lines represent the difference from the highest concentration cut, the dashed lines represent the difference from the lowest concentration cut.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_cnfw_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_cnfw_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_cnfw_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_mcf_cnfw_z00_hosts_match.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the NFW profile utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_vrat_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_vrat_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_vrat_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_mcf_vrat_z00_hosts_match.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the velocity ratio utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_s_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_s_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_s_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_mcf_s_z00_hosts_match.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the shape of the halo utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_ns_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_ns_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_ns_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_mcf_ns_z00_hosts_match.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the satellite number of the halo utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}

\begin{figure*}
	\centering
	\subfloat[L0125]{{\includegraphics[width=.45\textwidth]{L0125_mcf_spin_z00_hosts_match.pdf}} }
	\subfloat[L0250]{{\includegraphics[width=.45\textwidth]{L0250_mcf_spin_z00_hosts_match.pdf}} }
	\\
	\subfloat[L0500]{{\includegraphics[width=.45\textwidth]{L0500_mcf_spin_z00_hosts_match.pdf}} }
	\subfloat[Consuelo]{{\includegraphics[width=.45\textwidth]{L0500_mcf_spin_z00_hosts_match.pdf}} }
	\caption{The marked correlation function for the concentration defined according to the spin parameter of the halo utilizing the catalogs matched against the halo catalog of the best fit overdensity parameter. The shaded bands represent 2-sigma confidence regions generated by randomization of the marks. The dashed line denotes the largest halo radius for a given value of the overdensity parameter.}
\end{figure*}
%----------------------
\section[]{Conclusions}
