...
In \S~\ref{section:data} of this paper, we discuss the cosmological simulations 
that we analyze and halo identification. In \S~\ref{section:haloprops}, we consider 
the halo properties of interest and their standard definitions. In \S~\ref{section:methodology}, 
we discuss the statistics that we use to measure environmental effects through a
...
\eeq
%
The halo shapes we used were measured by \arz{Now you need to put a sentence or 
...
an order of magnitude higher mass \arz{than what? if you're making a comparison, you have to 
say what you are comparing it to.}. 
...
\arz{We need some number here or this needs to be rephrased.}
...
\begin{figure}
	...
	\caption{
\arz{1. Can you show the $\Delta=20$ run for low-mass as it might interestingly fill in that white space? If you 
have $\Delta=70$ for the mid-mass, can you also show that. If you implement my comment 2., then I think 
we do not need to worry too much about making the plots look too busy.}
\arz{2. Is it possible to avoid using yellow, it is nearly invisible to me? Also, I like the idea of using a color 
scheme that is based on a single color, similar to what Cat does in her plots. Making multiple colors 
requires the reader to check the legend. Using the darkness of a single color is more obvious: darker 
values give higher $\Delta$. That would be much better.}
...
the color scheme change I'm asking for, cleanliness of the plot should not be a real issue.}
...
\begin{figure}
	...
	\caption{
\arz{It looks like we could use a $\Delta=10$ line in the mid-mass and low-mass panels as well, just to be sure.}
