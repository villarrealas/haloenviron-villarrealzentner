...
In the concordance cosmology, galaxies and clusters form within merging dark matter halos \citep{white_etal78,blumenthal_etal84, mo_etal10}. Numerical simulations have provided a solid understanding of the abundances, properties, and 
...
yang_etal09b,zehavi_etal11,guo_etal11,wake_etal11,yang_etal11a,yang_etal12,leauthaud_etal12,
...
concentration \citep{wechsler_etal06,faltenbacher_white10, mao_etal15}, and other halo properties \citep{bett_etal06, hahn_etal07a, hahn_etal07b, faltenbacher_white10, vandaalen_etal12, fisher_faltenbacher16, sunayama_etal16}\arz{NEED SOME ADDITIONAL CITATIONS HERE.}. 
...
surrounding larger halos. \citep{wang_etal07, warnick_etal08, more_etal15} \arz{Need citations here to work by Wang (2007), the recent work on splashback (backsplash) 
...
spherical halos. We find that \arz{two or three sentence, relatively non-technical summary of our results 
should go here.}
...
this relationship please to confirm that it is roughly 10\%.}.
...
\simA, the red line corresponds to \simB, and the cyan line corresponds to \simC. The error bars designate the 
dispersion on NFW concentration at fixed halo mass. 
Each simulation is subject to resolution limitations at different halo masses. We show with vertical lines 
the minimum $M_{200}$ mass thresholds that we adopt in our analyses using the same color code as 
the concentration-mass relations. Note the deviation from a monotonic trend as a result of resolution effects. 
...
\caption{An example of the relationship between the velocity ratio concentration and halo mass for each of our simulations for $\Delta =200$. The chosen lower limit on halo mass for our sample is marked as a blue, red, or cyan line for \simA, \simB, and \simC \ respectively. Note the deviation from a monotonic trend as a result of resolution effects. \arz{Same comments as 
...
halos lie. The black dashed line shows something... \arz{I don't know what the black dashed line shows, 
...
the auxiliary properties that we consider are a function of mass \citep{bullock01,allgood06, duffy08, despali16}. 
...
Sheth papers that should be cited here, maybe more. Check on that.}. 
...
define the halos. \arz{which concentration?} 
First, it is clear that clustering strength generally depends upon the auxiliary properties of
halos at all halo mass thresholds. \arz{How can you make a statement about auxiliary properties 
in general, when you only plot concentration?}
