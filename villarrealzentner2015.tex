...
method, but I certainly could whip that together pretty quickly, if still desired.}\asv{Changed to address our new method of using rank as our mark.}
...
to other work easier. Once these cuts have been applied, we again divide the halos that meet these cutoffs into bins in logarithmic halo mass and follow the same procedure as with the other auxilary halo properties.
