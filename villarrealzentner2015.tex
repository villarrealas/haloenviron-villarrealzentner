...
in the remainder of this work. We have experimented with a variety of methods
to remove the gross mass dependences of these auxillary properties including
different choices in property binning. We find that our qualitative results are not sensitive to
the number of bins we use or the choice of median or mean property.
...
that meet the criteria that the ratio $V_{\mathrmPmax,sub}}/V_{\mathrm{max,host}} \ge 0.3$, where
...
we do not need to worry too much about making the plots look too busy.}\asv{Can do.}
...
values give higher $\Delta$. That would be much better.}\asv{I will experiment with the blues Color Map and shifting to only using the darker section of it.}
