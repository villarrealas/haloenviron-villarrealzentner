...
\yao{use a sequential colormap}\asv{Can do, probably won't make this circulation.}}
...
\begin{figure}
	...
	\caption{A comparison of the average ratio between $r_{200}$ and the splashback radius as determined by
	 \citet{more_etal15} (red circles) to the average ratio between $r_{200}$ and the halo radius determined as our
	  ...
	  numerous) halos dominate the calculation. \yao{maybe change the red dots (theory) to a red line (but keep blue dots as dots)?}}
