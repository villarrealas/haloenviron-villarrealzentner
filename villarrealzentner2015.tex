...
halo is dependent on halo concentration \citep{wechsler02, wechsler06}. \arz{Using this twice! argh! Such a
...
\asv{Hopefully that is sufficient! Unsure how to make a lebel for the color bar at this time, but looking into remaking this plot. The code may have been on the previous computer, so I'll take a little bit of time to recall how I went through this plot.}
}
...
within the literature \citep{allgood06, duffy08}. We are interested in studying the clustering behavior of halos
...
\citep{wechsler02, gao05, zentner07, wechsler06, harker06, croton07, dalal08}\arz{Cite all the usual 
...
samples. In each panel in Fig.~\ref{fig:cc_cfcompare}, we designate the radii of the largest halos 
...
\asv{This information is not currently run, but should be trivial to add to the halotools setup. I'll add it after this initial recheck with the new normalizations.}
...
\asv{Can definitely do all of this pretty straightforward now. The plotting pipeline is all ready to go and the halo concentration cuts are fairly minimal in terms of time constraints comparedto the rest of the global work. I'll do cuts for all properties at 10\%, 20\%, and 50\% for purposes of testing, especially given our concern for the tails. It appeared that this mainly mattered with regards to spin.}
...
sheth04, gao05, zentner05, allgood06, harker06, wechsler06, croton07, dalal08}
...
reminiscent of much recent work on the so-called halo ``splashback radius." 
