...
clustering of dark matter halos in the standard cosmological model. As such, it is possible to compute the 
...
exploit these measurements to constrain galaxy evolution \citep[e.g.,][]{yang03,tinker05,zehavi05a,porciani06,vdBosch07,Zheng07,conroy_wechsler09,yang09b,zehavi_etal11,guo_etal11b,wake_etal11,yang11a,yang12,leauthaud_etal12,rod_puebla12,tinker_etal13,cacciato_etal13,more_etal13,guo_etal14,zu_mandelbaum15b}.
To date, the vast majority of halo occuption models rely on two assumptions. 
The first is that the statistics of objects within a dark matter halo is a function of the mass
